...
====== Achat - paiement valide

[plantuml, target=order-success-sequence, format=png, align=center]
----
...
====== Achat - paiement non valide

[plantuml, target=order-fail-sequence, format=png, align=center]
----
...
validation -[#red]> log : FAIL - consigner l'échec le paiement
...
[plantuml, target=site-map, format=png, align=center, pdfwidth=66%]
----
...
Code source dossier projet (fichier pdf) créer en asciidoctor, integrant plantuml pour générer les schemas.

include::dossier_projet.txt[]
